...
- [gRPC Deep Dive](/learning/communication-patterns-grpc-deep-dive) — Protobuf in gRPC context
- [What is Kafka](/learning/kafka-what-is-kafka) — Avro in Kafka pipelines
- Schema Registry Avro — Schema Registry deep dive
