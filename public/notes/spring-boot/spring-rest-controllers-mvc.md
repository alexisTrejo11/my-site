...
// Handled globally — see [[02_Global_Exception_Handling]]
```
...
## Related Notes
- [[02_Global_Exception_Handling]] — Centralized errors
- [[01_Spring_Security_Architecture]] — Securing endpoints
- [[01_Testing_Slice_Annotations]] — `@WebMvcTest`
