...
- The Backend Glosary — API, REST, RPC, GraphQL definitions
- [gRPC Deep Dive](/learning/communication-patterns-grpc-deep-dive) — gRPC internals
- [Serialization Protocols](/learning/communication-patterns-serialization-protocols) — JSON vs Protobuf vs Avro
- REST Controllers — Spring Boot REST implementation
