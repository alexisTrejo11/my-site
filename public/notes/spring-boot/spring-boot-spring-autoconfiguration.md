...
## Related Notes
- [Spring Core and IoC](/learning/spring-boot-spring-core-ioc) — Bean fundamentals
- [Properties Profiles and YAML](/learning/spring-boot-spring-properties-profiles-yaml) — `@ConditionalOnProperty`
- [Actuator and Metrics](/learning/spring-boot-spring-actuator-metrics) — Startup health checks
