...
> Probabilistic structure: quickly tells you a key is **definitely not** present.

## What it is

- No false negatives; possible false positives (then verify).
- Used in [LSM Tree](/learning/software-engineer-lsm-tree) SSTables and distributed joins.
- Space-efficient membership tests.

## Why it matters

Understanding **Bloom Filter** helps you reason about trade-offs in production data systems — when to apply it, what breaks at scale, and how it connects to neighboring ideas in this section.
