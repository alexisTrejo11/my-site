...
> Moving partitions or hash ranges between nodes to equalize load.

## What it is

- Triggered by added capacity or detected skew.
- Must avoid serving stale routes during migration.
- Often incremental with dual-read/dual-write phases.

## Why it matters

Understanding **Rebalancing** helps you reason about trade-offs in production data systems — when to apply it, what breaks at scale, and how it connects to neighboring ideas in this section.
