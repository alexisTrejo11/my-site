...
- [Monoliths vs Microservices](/learning/architecture-patterns-monoliths-vs-microservices) — Detailed comparison
- [Welcome to the Machine](/learning/introduction-welcome-to-the-machine) — Current model overview
- [What is Kafka](/learning/kafka-what-is-kafka) — Why event-driven emerged
