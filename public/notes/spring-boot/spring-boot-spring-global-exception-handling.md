...
## Related Notes
- [REST Controllers and MVC](/learning/spring-boot-spring-rest-controllers-mvc) — `@Valid` on controllers
- [Transaction Management](/learning/spring-boot-spring-transaction-management) — Rollback + error mapping
- [Global Error Handling](/learning/fastapi-global-error-handling) — FastAPI equivalent (vault)
