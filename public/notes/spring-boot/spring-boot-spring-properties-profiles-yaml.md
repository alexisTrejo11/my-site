...
## Related Notes
- [Autoconfiguration Lifecycle](/learning/spring-boot-spring-autoconfiguration) — `@ConditionalOnProperty`
- [JPA Hibernate and Data JDBC](/learning/spring-boot-spring-jpa-hibernate) — Datasource config
- [Spring MOC](/learning/spring-boot-master-moc) — Roadmap
