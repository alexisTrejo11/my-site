...
- [Authentication AuthZ](/learning/observability-and-security-authentication-authorization) — Security layer alongside observability
- Spring Profiles — Environment-specific observability config
- Observability — Kafka observability patterns
