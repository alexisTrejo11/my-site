...
- [What is Kafka](/learning/kafka-what-is-kafka) — The async messaging layer
- [gRPC Deep Dive](/learning/communication-patterns-grpc-deep-dive) — Sync with streaming over HTTP/2
- [Executor Framework](/learning/java-executor-framework) — Java threading fundamentals
- [Future CompletableFuture](/learning/java-future-completablefuture) — Java async composition
