...
## Related Notes
- [Transaction Management](/learning/spring-boot-spring-transaction-management) — Transaction boundaries
- [Testing Slice Annotations](/learning/spring-boot-spring-testing-slices) — `@DataJpaTest`
- [Advanced ORM Optimization](/learning/django-advanced-orm-optimization) — Django ORM comparison (vault)
