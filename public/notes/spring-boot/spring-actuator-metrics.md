...
Virtual threads don't fix **lazy loading** or **thread-bound** Hibernate session issues — transaction boundaries still matter. See [[02_Transaction_Management]].
...
## Related Notes
- [[01_Spring_Security_Architecture]] — Securing `/actuator`
- [[01_Testing_Slice_Annotations]] — `@SpringBootTest` health checks
- [[02_Autoconfiguration_Lifecycle]] — Conditional actuator auto-config
