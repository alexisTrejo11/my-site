...
> Log-Structured Merge tree — write-optimized storage used in Cassandra, RocksDB, LevelDB.

## What it is

- Writes go to memory (memtable) then flush to immutable SSTables.
- [Compaction](/learning/software-engineer-compaction) merges files; reads may check multiple levels.
- Excellent write throughput; read amplification possible.

## Why it matters

Understanding **LSM Tree** helps you reason about trade-offs in production data systems — when to apply it, what breaks at scale, and how it connects to neighboring ideas in this section.
