...
- [Authentication AuthZ](/learning/observability-and-security-authentication-authorization) — What CORS does NOT replace
- [The Perfect API Design](/learning/introduction-api-design) — API contracts and versioning
- [The Three Pillars](/learning/observability-and-security-three-pillars-observability) — Monitoring rate limit violations
